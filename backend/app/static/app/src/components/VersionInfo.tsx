  ...
  return (
    ...
    >
      <div className="space-y-4">
        <InfoItem label="Versione" value={data.version || 'N/A'} icon="fas fa-tag" />
        <InfoItem 
          label="Commit" 
          value={<Badge text={data.git_commit || 'N/A'} type="info" />} 
          icon="fas fa-git-alt"
        />
        <InfoItem label="Branch" value={data.git_branch || 'N/A'} icon="fas fa-code-branch" />
      </div>
    </InfoCard>
  )
}
